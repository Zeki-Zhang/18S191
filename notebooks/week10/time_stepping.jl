...
# ╔═╡ 4d87aa07-7622-466e-b554-f94dde3518b4
using Optim
...
# ╔═╡ 736ead8a-2b57-4e20-a4f1-d4d884379d2b
loss((x, y)) = ((1 - x) * (1 - y) - .9)^2

# ╔═╡ 8be3fe70-ce96-433c-880e-47b1e42aa3c9
result = optimize(loss, [.07, .03])

# ╔═╡ 3e537192-dd41-4c58-abf6-10e6e63630c1
result.minimizer
