...
using Plots, Colors, PlutoUI, StatsBase, HypertextLiteral
...
# ╔═╡ 1f00fda9-e9b1-43ed-9fe2-f0f01d4cff6a
...
@bindname N Slider(2:20, show_value=true, default=8)

# ╔═╡ 27da0254-f760-4ab6-8ccb-1d2c884ac1a1
@bindname prob Slider(0.01:.01:1, show_value=true, default=.1)

# ╔═╡ 5d414452-8be8-11eb-233e-2d81eaacbfb6
simulation = simulate(N, prob)

# ╔═╡ 9fe2e802-67ea-41d7-94e1-d3e04bc80f01
